...
private:
  ...
  /*! 
    Contient les parametres de la relation entre le niveau dï¿½eau dans le 
    reservoir (m) et le volume emmagasinï¿½ (millions de m3).
  */
  ...
  */
  ...
  /*!
    Contient les parametres de la relation entre le le volume emmagasinï¿½ (millions de m3),
  ...
  */
  ...
  /*!
    ...
    du reservoir vers au autre carreau ï¿½ l'interieur du bassin versant.
  */
