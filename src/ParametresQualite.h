...
public:
  ...
  /*! Coefficient permettant d'augmenter ou de diminuer
    l'importance de l'�vaporation dans le bilan d'�nergie */
  float cevapo;
  //! Coefficient convection.
  /*! Coefficient permettant d'augmenter ou de diminuer
      l'importance de la convection dans le bilan d'�nergie */
  float cconve;
  //! Critere de gel.
  float crigel; 
  ...
  //! couverture du sol par la canop� de la for�t (entre 0.0 et 1.0)
  float ccanope;
  float hombre;
};
