...
[**ClassList**](annotated.md) **>** [**EvapoKPenman**](classEvapoKPenman.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EvapoKPenman**](#function-evapokpenman-12) () <br>_Constructeur._  |
|   | [**EvapoKPenman**](#function-evapokpenman-22) (int latitudeMoyenneBV, int nbCE, int pasParJour) <br> |
...
|   | [**~EvapoKPenman**](#function-evapokpenman) () <br> |
...
```C++
virtual int EvapoKPenman::assimiler (
...
```C++
virtual int EvapoKPenman::calculerEvapo (
    const int & noJour,
    const Meteo & meteo,
...
```C++
virtual int EvapoKPenman::initialiserAssimilations (
...
```C++
virtual void EvapoKPenman::initialiserEtats (
...
```C++
virtual void EvapoKPenman::lireParametres (
...
```C++
virtual mxArray * EvapoKPenman::obtenirEtats (
...
```C++
virtual mxArray * EvapoKPenman::obtenirEtatsAvantAssimilations (
    const std::vector< bool > filtreCE
) 
```
...
```C++
virtual void EvapoKPenman::preserverEtatsPasDeTemps () 
```
